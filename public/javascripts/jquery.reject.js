...
(function($) {
	$.reject = function(opts) {
		...
		element.find('#jr_overlay').css({ // Creates 'background' (div)
			...
			position: 'relative',
			height: 'auto',
			minWidth: 400 + displayNum * 100,//displayNum*100,
			maxWidth: 400 + displayNum * 140,//displayNum*140,
			width: $.layout.name == 'trident' ? 400 + displayNum * 155 : 'auto', // min/maxWidth not supported by IE
			padding: 20,
			fontSize: 12
